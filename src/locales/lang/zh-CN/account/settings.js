export default {
  ...
  'account.settings.menuMap.security': '密码设置',
  ...
  'account.settings.basic.nickname': '电话号码',
  'account.settings.basic.nickname-message': '请输入您的昵称!',
  'account.settings.basic.profile': '家庭住址',
  'account.settings.basic.profile-message': '请输入家庭住址!',
