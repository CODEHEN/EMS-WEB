          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="学年学期">
                <a-select placeholder="请选择" v-model="queryParam.semester">
                  ...
                  <a-select-option value="2019-2020-2">2019-2020-2</a-select-option>
                  <a-select-option value="2019-2020-1">2019-2020-1</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
...
name: 'Semester',
  ...
  return {
    timetables: [
      ['软件开发项目实训（JAVA开发方向）\n' + '甄春成\n' + '知行楼502Web前端开发技术实验（训）室', null, null, '毛概', '选修'],
